@echo off
rem /**
rem  * Copyright &copy; 2012-2016 <a href="https://github.com/yogee/youge">JeeSite</a> All rights reserved.
rem  *
...
rem �滻 yogee.properties �еİ汾��
echo.
set f=%cd%\src\main\resources\yogee.properties
echo [INFO] Update %f%
set s1=version=
