	...
	<script type="text/javascript">
		$(document).ready(function() {
			...
			function getNotifyMsg(){
				$.get("${ctx}/ebuy/ebuyLogMsgcode/getCountFromDate",function(data){
					var num = parseInt(data);
					if (num < 100){
						$("#msgWaring").show()
						$("#notifyNum").show().html("1");
						$("#notifyNum3").show().html(num);
					}else{
						$("#msgWaring").hide()
						$("#notifyNum,#notifyNum2").hide()
					}
				...
				<ul id="userControl" class="nav pull-right">
					...
					<li id="userInfo" class="dropdown">
						...
						<ul class="dropdown-menu">
							...
							<li id="msgWaring"><a href="##" target="mainFrame"><i class="icon-envelope-alt"></i>&nbsp;  短信仅剩 <span id="notifyNum3" class="label label-info hide"></span> 条</a></li>
						</ul>
					</li>
