...
public class HttpKit {
    ...
    public static void main(String[] args) {
        ...
        //  String result = get("http://m.cyjoycity.com/activity/eventlist");
        // System.out.println(result);

        Map map = new HashMap();
        map.put("grant_type","client_credentials");
        map.put("client_id","YXA6ZITRoNH7EeSlqLE2Z0h5hg");
        map.put("client_secret","YXA6jrSYbm8gRIYjfuE0p_3Z-m5Zm4I");
