...
2. 修改src\main\resources\yogee.properties文件中的数据库设置参数。
...
* <https://github.com/yogee.youge/tree/master/doc>

## 如何交流、反馈、参与贡献？

* QQ Group：127515876 &nbsp; 209330483 &nbsp; 223507718 &nbsp; 苹果版QQ若不能加入请使用手机QQ最新版
* E-mail：thinkgem@163.com
* GitHub：<https://github.com/yogee.youge>
* 开源中国：<http://git.oschina.net/yogee.youge>
...
如果你仍然喜欢Hibernate，请点击[下载JeeSite Hibernate版本](https://github.com/yogee.youge/tree/master_hibernate)。
